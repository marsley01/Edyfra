...
export function LongPressActions({
  ...
  return (
    <motion.div
      ...
      className="pointer-events-auto absolute top-full left-1/2 -translate-x-1/2 mt-2 z-50 flex items-center gap-1.5 px-2 py-2 rounded-2xl bg-card/95 backdrop-blur-lg border border-border shadow-[0_12px_40px_rgba(0,0,0,0.6)]"
    >
      <IslandIconButton
        onClick={onToggleMic}
        active={!isMuted}
