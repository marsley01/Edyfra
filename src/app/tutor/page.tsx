...
import {
  ...
  ChevronRight, Sparkles, Star, Video, Home
} from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-secondary/10 to-primary/5 relative overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 z-10">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-4xl sm:text-5xl font-black tracking-tightest">Dashboard</h1>
          <p className="text-muted-foreground mt-2 text-lg font-medium">Manage your schedule, profile, preferences, and account</p>
        </div>
