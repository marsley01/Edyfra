      ...
      <div className="border-t border-gray-100 p-4">
        <div className="rounded-lg bg-gray-50 p-3">
          <div className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gray-500">
            <span className="rounded bg-primary px-1.5 py-0.5 text-primary">{schoolCode}</span>
...
function SidebarLink({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "group flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-gray-500 transition-colors hover:bg-primary/60 hover:text-primary",
      )}
    >
      <Icon className="h-4 w-4" />
      {label}
