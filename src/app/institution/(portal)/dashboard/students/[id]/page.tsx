    ...
    <div className="space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <SubjectBarChart
              ...
              series={[
                { name: "This term", dataKey: "thisTerm", color: "#FF9500" },
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center gap-2 text-base font-black">
              <GraduationCap className="h-4 w-4 text-primary" /> Sessions attended
            </CardTitle>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center gap-2 text-base font-black">
              <Bot className="h-4 w-4 text-primary" /> Edyfra activity
            </CardTitle>
      ...
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="flex items-center gap-2 text-base font-black">
            <Users className="h-4 w-4 text-primary" /> Coaching
          </CardTitle>
        </CardHeader>
            ...
            {profile.coaching.current.length === 0 ? (
              ...
              <ul className="mt-2 space-y-2">
                {profile.coaching.current.map((c) => (
                  <li
                    key={c.id}
                    className="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-primary bg-primary/40 p-3"
                  >
                    <div>
...
function Stat({
  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white px-3 py-2">
      <div className="mx-auto flex h-7 w-7 items-center justify-center rounded-lg bg-primary text-primary">
